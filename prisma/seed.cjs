/**
 * Seed de producción/local sin TypeScript runner (tsx).
 * Uso: node prisma/seed.cjs
 */
/* eslint-disable @typescript-eslint/no-require-imports */
const { PrismaClient, UserRole, DriverStatus, ExpenseStatus, ExpenseSource } = require('@prisma/client');
